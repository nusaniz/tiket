...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($row["status"] == "") {
            // Tiket valid, update status menjadi "Telah divalidasi"
            $update_sql = "UPDATE halo SET status = 'Telah divalidasi' WHERE ticket_code = '$ticket_code'";
			...
			echo "Nama: " . $row["name"] . "<br>";
			echo "Seat: " . $row["seat"] . "<br>";
			//echo "Status Tiket: " . $row["status"] . "<br>";
